...
python3 DC81nodes.py --batch_set_size 200 --batch_choice 0
"""
...
params = {
        'batch_size': 10,
        'epochs': 20000,
        'path': "VanillaRL_NoHyper_81_3_" + str(hyper_parameter['batch_C_numbers']),
        'recover': False,
...
def main():
    ...
    params['path'] = "DC_81_" + str(hyper_parameter['batch_set_choice']) + "_" + str(hyper_parameter['batch_C_numbers'])
