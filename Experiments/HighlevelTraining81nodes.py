...
python3 HighlevelTraining81nodes.py --batch_set_size 200 --batch_choice 0
"""
...
def train(params):
    ...
    while epoch_i < params['epochs']:
        ...
        # external, we only replay_buffer the external knowledge, but not train it directly
        epoch_i += 1
        if epoch_i > 30:
...
def main():
    ...
    params['path'] = "81nodes_" + str(hyper_parameter['batch_set_choice']) + "_" + str(hyper_parameter['batch_C_numbers'])
